...
contract Domains is ERC721URIStorage {
  // var inherited from ERC721URIStorage
  ...
  // A mapping of the domain name to the address
  mapping (uint => string) public names;

  // New Solidity error handling structures
  error Unauthorized();
  error AlreadyRegistered();
  error InvalidName(string name);
  error NotEnoughMoney(uint price);

  // Contract events
  event DomainMinted(string _name, address _owner, uint256 _TokenId);

// We make the contract "payable" so that we can use it to buy domains
  constructor(string memory _tld)  ERC721("Plus Name Service", "PNS") payable {
    owner = payable(msg.sender);
    tld = _tld;
    // console.log("");
    console.log("%s name service deployed\n", _tld);
    // console.log("*************** Contract constructor **********************************************.");
    // console.log("Con esto iniciamos el contrato de Dominios, padrisimo.");
    // console.log("v 0.1 - domains Mapping and its getter/setter (register) added.");
    // console.log("v 0.1 - records Mapping and its getter/setter  added.");
    // console.log("v 0.2 - string tld set on constructor to define top level domain (TLD) added.");
    // console.log("***********************************************************************************.");
    // console.log("");
    // console.log("Ouput: ");
    // console.log("");
 ...
 // This function will give us the price of a domain based on length
  ...
  function register(string calldata name) public payable{
     ...
     // require(msg.value >= _price, "Not enough Matic paid");
      if (msg.value < _price) revert NotEnoughMoney(_price);
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the PLUS name service", "image": "data:image/svg+xml;base64,',
    ...
    emit DomainMinted(name, msg.sender, newRecordId);
    }
